.PHONY: install up down logs logs-worker logs-scheduler migrate seed test lint demo run-worker run-scheduler enqueue-demo-leads enqueue-enrichment sync-google-sheets live-demo export-csv export-xlsx export-form-leads-csv export-form-leads-xlsx
